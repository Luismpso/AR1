...
def main() -> None:
    ...
    from AR1.agents.control import NStepSarsaControl
    ...
    try:
        ...
        print("- PL5/envs/windy_gridworld.py")
        print("- PL5/agents/control/sarsa.py")
        print("- PL5/agents/control/n_step_sarsa.py")
