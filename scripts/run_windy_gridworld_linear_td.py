...
def main() -> None:
    ...
    from AR1.agents.control import SarsaControl
    from AR1.agents.prediction.linear_td import LinearTD0
    from AR1.envs.windy_gridworld import ACTIONS, WindyGridworldEnv
    from AR1.experiments.control import train_control_agent
    from AR1.experiments.fa_training import train_linear_td_agent
    from AR1.features.windy_gridworld import TILE_STATE_DIM, tile_features
    from AR1.plots.windy_gridworld import plot_td_errors, plot_value_heatmap
