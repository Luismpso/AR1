...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=str, default="outputs/blackjack_prediction", help="Directory inside AR1 where plots will be saved.")
...
def main() -> None:
    ...
    from AR1.agents.prediction import FirstVisitMonteCarloPrediction, TD0Prediction
    from AR1.envs.blackjack import BlackjackEnv
    from AR1.experiments.training import generate_episode, train_prediction_agent
    from AR1.plots.blackjack import plot_value_difference, plot_value_function
    ...
    try:
        ...
        print("- PL5/envs/blackjack.py")
        print("- PL5/agents/prediction/monte_carlo.py")
        print("- PL5/agents/prediction/td.py")
